...
CREATE TABLE public.case_types (
    ...
    case_type public.citext NOT NULL,
    description text,
...
--
-- Name: case_types_case_type_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.case_types ALTER COLUMN case_type_id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.case_types_case_type_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: case_types case_types_case_type_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.case_types
    ADD CONSTRAINT case_types_case_type_key UNIQUE (case_type);
...
ALTER TABLE ONLY public.cases
    ADD CONSTRAINT cases_case_type_id_fkey FOREIGN KEY (case_type_id) REFERENCES public.case_types(case_type_id) ON DELETE SET NULL;
